...
const Header = () => {
    return (
        ...
        <div className="container mx-auto lg:flex  lg:gap-x-8 flex lg:items-start lg:justify-start  justify-center items-center py-8 px-5 lg:py-16 lg:px-10 xl:px-0">
            ...
            <motion.div initial={{opacity: 0}} animate={{ opacity: 1}} transition={{delay: .3, duration: .7}} className='lg:flex lg:flex-auto xl:flex xl:justify-end hidden xl:max-h-auto'>
