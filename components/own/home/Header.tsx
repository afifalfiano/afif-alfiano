...
const Header = () => {
    return (
        ...
        <div className="container mx-auto lg:grid lg:grid-cols-2  pb-10 lg:pt-6 lg:pb-16 lg:gap-x-10 flex lg:items-start lg:justify-start  justify-center items-center py-8 px-5">
            <motion.div initial={{opacity: 0}} animate={{ opacity: 1}} transition={{delay: .3, duration: .7}} className="flex flex-col justify-center items-start flex-auto ">
                ...
                <h2  className='lg:text-5xl text-white  lg:pb-8 font-semibold text-3xl pb-4 text-center w-full'>Frontend Developer</h2>
                <h1 className='lg:text-8xl text-5xl text-white lg:pb-8 pb-4 font-bold text-center w-full'>Afif Alfiano</h1>
